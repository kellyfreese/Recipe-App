...
#This code creates a database called 'recipes.db'
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///recipes.db'
db = SQLAlchemy(app)

#This code creates the databse model that we need. The model is called 'Recipe'
...
#Define a route and give it the path where we want our recipes to be available
